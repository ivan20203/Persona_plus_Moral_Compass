...
class OllamaModel(BaseModel):
    ...
    def generate_responses(self, messages, num_responses: int = 5):
        """Generate responses by chatting with the Ollama server."""
        ...
        for i in range(num_responses):
            try:
                ...
                responses.append(f"ERROR: Failed to generate response: {exc}")
                time.sleep(2)
                continue
